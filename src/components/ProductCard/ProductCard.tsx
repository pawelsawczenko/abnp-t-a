  ...
  return (
    <div className="relative w-xs rounded-md bg-stone-300 p-4 shadow-md transition hover:bg-stone-200 hover:shadow-xl dark:bg-slate-600 hover:dark:bg-slate-700">
      ...
      <div className="mb-4 flex justify-between">
        <p className="pt-4 pb-4 font-semibold dark:text-white">{price}$</p>

        <button
          className="cursor-pointer rounded-md bg-amber-300 p-4 font-semibold hover:bg-amber-200 dark:bg-sky-600 dark:text-white hover:dark:bg-sky-500"
